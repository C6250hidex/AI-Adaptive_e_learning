(function attachDashboard(window, document) {
  ...
  const learningPaths = {
    Python: [
      {
        title: "Variables",
        text: "A Python variable is a name that stores data. Think of it as a labeled container: the label stays the same, but the value inside can change as your program runs.",
        code: 'name = "John"\nage = 25\n\nprint(name)\nprint(age)',
        quiz: {
      ...
      {
        title: "Loops",
        text: "A loop repeats a block of code while a condition is true or while there are items left to process. Python commonly uses for loops for sequences and while loops for conditions.",
      ...
      {
        title: "Functions",
        text: "A function is a reusable block of code. It can receive inputs called parameters, perform work, and return a result.",
        code: 'def greet(name):\n    return f"Hello, {name}!"\n\nprint(greet("Student"))',
        quiz: {
      ...
      {
        title: "OOP",
        text: "Object-Oriented Programming organizes code into objects that combine data and behavior. It helps model real-world concepts like users, carts, and bank accounts.",
      ...
      {
        title: "Classes",
        text: "A class is a blueprint for creating objects. Each object can keep its own data while sharing methods from the class.",
      ...
      {
        title: "File I/O",
        text: "File input/output lets programs write information to files and read it later. This is useful for logs, settings, reports, and saved data.",
      ...
      {
        title: "Modules",
        text: "A module is a file of reusable Python code. You use import statements to bring built-in or custom module features into your program.",
    ...
    JavaScript: [
      {
        title: "JS Syntax",
        text: "JavaScript syntax is the set of rules for writing valid statements. Modern JavaScript commonly uses let and const for variables.",
        code: 'const platform = "AI Learn";\nlet lessons = 5;\n\nconsole.log(`${platform}: ${lessons} lessons ready`);',
        quiz: {
          question:
            "Which keyword declares a block-scoped JavaScript variable?",
      ...
      {
        title: "JS Operators",
        text: "Operators assign, compare, and calculate values. JavaScript includes arithmetic operators, comparison operators, and logical operators.",
      ...
      {
        title: "JS If Else",
        text: "Conditional statements let your code choose different actions. if runs one block when a condition is true, and else handles the alternative.",
      ...
      {
        title: "JS Loops",
        text: "Loops execute code repeatedly. A for loop is useful when you know the range or collection you want to iterate over.",
      ...
      {
        title: "JS Strings",
        text: "Strings store text. JavaScript strings can use single quotes, double quotes, or template literals for embedded values.",
      ...
      {
        title: "JS Numbers",
        text: "JavaScript has one main Number type for integers and decimals. The Math object provides common numeric helpers.",
      ...
      {
        title: "JS Functions",
        text: "A JavaScript function is a reusable block of code that runs when called. It can receive parameters and return a value.",
    ...
    Java: [
      {
        ...
        text: "Type casting converts a value from one type to another. Java can widen some values automatically, but narrowing conversions must be explicit.",
      ...
      },
      {
        ...
        text: "Java operators perform arithmetic, assignment, comparison, and logical operations on variables and values.",
      ...
      {
        title: "Java Strings",
        text: "A Java String is an object with methods for working with text, including length(), toUpperCase(), and indexOf().",
      ...
      {
        title: "Java Math",
        text: "The Java Math class provides common helpers such as max(), sqrt(), round(), and random().",
      ...
      {
        title: "Java Booleans",
        text: "A boolean can only be true or false. Booleans are central to conditionals and comparisons.",
      ...
      {
        title: "Java If...Else",
        text: "Java uses if, else if, and else to run different code blocks depending on conditions.",
      ...
      {
        title: "Java Switch",
        text: "A switch statement chooses one matching case from many options. break stops execution from falling through to later cases.",
    ...
    "C++": [
      {
        title: "C++ Intro",
        text: "C++ is a high-performance language used for systems, games, tools, and applications that need strong control over memory and runtime behavior.",
      ...
      {
        title: "C++ Syntax",
        text: "C++ statements usually end with semicolons. A complete program commonly includes headers and a main() function.",
        code: '#include <iostream>\n\nint main() {\n  std::cout << "AI Learn";\n  return 0;\n}',
        quiz: {
      ...
      {
        title: "C++ Output",
        text: "std::cout sends output to the console. The insertion operator << passes values into the output stream.",
      ...
      {
        title: "C++ Comments",
        text: "Comments explain code without running. Single-line comments start with // and block comments use /* and */.",
      ...
      {
        title: "C++ Variables",
        text: "C++ variables must have a declared type, such as int, double, char, bool, or std::string.",
      ...
      {
        title: "C++ User Input",
        text: "std::cin reads user input from the console. Values are stored in variables using the extraction operator >>.",
      ...
      {
        title: "C++ Data Types",
        text: "Data types tell the compiler what kind of value a variable stores and how much memory it may need.",
    ...
    Go: [
      {
        title: "Go Variables",
        text: "Go variables can be declared with var or with the short declaration operator := inside functions.",
      ...
      {
        title: "Go Constants",
        text: "Constants are fixed values declared with const. They cannot be reassigned after declaration.",
      ...
      {
        title: "Go Output",
        text: "Go uses the fmt package for formatted output. Println adds a new line, while Printf supports formatting verbs.",
      ...
      {
        title: "Go Data Types",
        text: "Go is statically typed. Common types include int, float64, string, and bool.",
      ...
      {
        title: "Go Arrays",
        text: "A Go array has a fixed length. Once created, its size does not grow or shrink.",
      ...
      {
        title: "Go Slices",
        text: "Slices are flexible views over arrays. They can grow with append(), making them more common than arrays in everyday Go.",
      ...
      {
        title: "Go Operators",
        text: "Go supports arithmetic, comparison, and assignment operators. The ++ operator increments a numeric variable by one.",
        code: 'package main\n\nimport "fmt"\n\nfunc main() {\n  x := 10\n  x++\n  fmt.Println(x == 11)\n}',
        quiz: {
  ...
  function loadCompleted() {
    try {
      return new Set(
        JSON.parse(window.localStorage.getItem(COMPLETED_KEY) || "[]"),
      );
    } catch {
      return new Set();
    }
  ...
  function saveCompleted() {
    window.localStorage.setItem(
      COMPLETED_KEY,
      JSON.stringify(Array.from(state.completed)),
    );
  }
  ...
  function toggleDashboardNav() {
    const isOpen =
      elements.dashboardNavToggle?.getAttribute("aria-expanded") === "true";
  ...
  function renderSkillList() {
    ...
    lessons.forEach((lesson) => {
      ...
      topicButton.addEventListener("dblclick", () =>
        markLessonDone(lesson.title),
      );
  ...
  function startQuiz() {
    ...
    quiz.options.forEach((option, index) => {
      ...
      button.addEventListener("click", () =>
        checkAnswer(button, index, quiz.correct),
      );
  ...
  function checkAnswer(button, selectedIndex, correctIndex) {
    ...
    if (selectedIndex === correctIndex) {
      ...
      elements.quizFeedback.textContent =
        "Not quite. Review the lesson and try the next topic.";
  ...
  function updateScore(type, change) {
    state.scores[type] = Math.min(
      100,
      Math.max(0, Number(state.scores[type] || 0) + change),
    );
    saveScores();
    updateConfidence();
  }
  ...
  function updateRecommendation(confidence = null) {
    const score =
      confidence === null
        ? Math.round(
            (Number(state.scores.quiz || 0) + Number(state.scores.code || 0)) /
              2,
          )
        : confidence;
  ...
  function createMessage(role, text) {
    ...
    message.className =
      role === "You" ? "message user-message" : "message ai-message";
  ...
  async function sendMessage(event) {
    ...
    try {
      ...
      loadingMessage.replaceWith(
        createMessage(
          "AI",
          error.message || "Could not connect to the AI tutor.",
        ),
      );
    } finally {
  ...
  function downloadLessonPDF() {
    ...
    if (!printWindow) {
      api.showToast(
        "Allow popups to print or save this lesson as PDF.",
        "warning",
      );
      return;
    }
...
<body>
  ...
  function handleNewsletter(event) {
    ...
    const stored = JSON.parse(
      window.localStorage.getItem("aiLearnNewsletterEmails") || "[]",
    );
    if (!stored.includes(email)) {
      stored.push(email);
      window.localStorage.setItem(
        "aiLearnNewsletterEmails",
